...
export default class SelectHardware extends Component {
  ...
  renderButtons() {
    return (
      <>
        ...
        {this.props.isQRCodeOpen && (<div className='hw-connect__btn-wrapper--qr'>{this.renderConnectToQRButton()}</div>)}
      </>
    );
  }
  ...
  renderQRHardwareWalletSteps() {
    const steps = [];
    steps.push({
      title: 'QR Code Air-gapped Wallet',
      message: 'Air-gapped your private keys with QR code compatible hardware wallets.',
    });

    steps.push({
      message: 'Click on these supported wallets for further introduction:',
    });
